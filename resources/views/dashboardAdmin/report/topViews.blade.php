...
<div class="row">
   	...
   	<div class="col-md-6 col-md-offset-1">
           ...
           <div class="panel-heading"><b>Top Users Views File </b></div>
           <div class="panel-body">
               <canvas id="canvas_top_views" height="280" width="600"></canvas>
           </div>
       	</div>
   	</div>
...
<script> 
var url = "{{url('dashboardAdmin/report/topViews/getTopTopViews')}}";
var USER = new Array();
...
$(document).ready(function(){
  $.get(url, function(response){
    response.forEach(function(data){
        USER.push(data.name);
        JUMLAH.push(data.view_count);
        NAMA_FILE.push(data.judul);
    });
    var ctx = document.getElementById("canvas_top_views");
