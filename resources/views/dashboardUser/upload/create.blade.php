...
<div class="row">
	...
	<div class="col-10">
		...
		<div align="right">
			<a href="/dashboardUser/{{auth()->user()->id}}/upload" class="btn btn-info btn-sm">Back</a>
		</div>

		<form method="POST" action="/dashboardUser/{{auth()->user()->id}}/upload/store" enctype="multipart/form-data">
			@csrf
			...
			<div class="form-group">
				<label class="col-md-4 text-left">Pilih Category</label>
				<div class="">
