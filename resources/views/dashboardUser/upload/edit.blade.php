...
<div class="row">
	...
	<div class="col-10">
		...
		<div align="right">
			<a href="/dashboardUser/{{auth()->user()->id}}/upload" class="btn btn-default">Back</a>
		</div>

		<form method="POST" action="/dashboardUser/{{auth()->user()->id}}/upload/{{$data->id}}/update" enctype="multipart/form-data">
			@csrf
