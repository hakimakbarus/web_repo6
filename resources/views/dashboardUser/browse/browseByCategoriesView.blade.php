...
<div class="form-group">
    ...
    <form action="/dashboardUser/browse/category/byCategory/" method="post" class="form-inline">
    	@csrf
    ...
    <div class="card border-light mb-3 mx-4" style="max-width: 18rem; width: 18rem;">
      ...
      <div class="card-body">
        ...
        <a href="/dashboardUser/home/{{$row->id}}/showUpload" class="btn btn-primary">Show</a>
      </div>
      <?php 
